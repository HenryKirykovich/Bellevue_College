...
namespace HW2_Henadzi_Kirykovich
{
    public class InputData
    {
        ...
        {
            Student[] student = new Student[3];  // creating new object (array) from class Student and start gater information about two student  
            ...
            for (int i = 0; i < student.Length; i++)
            {
                try
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("Please input you number");
